      ...
      <Fade>
        <div className="flex justify-between section-container">
          <a href="#home" className="link">
            <Image src="/logo.svg" alt="Logo - Rohman" width={25} height={25} />
          </a>
          <div className="outer-menu relative">
            <SoundBar />
            {/* <SoundButton /> */}
            <input aria-labelledby="menu" className="checkbox-toggle link absolute top-0 right-0 w-6 h-6 opacity-0" type="checkbox" aria-label="menu" />
